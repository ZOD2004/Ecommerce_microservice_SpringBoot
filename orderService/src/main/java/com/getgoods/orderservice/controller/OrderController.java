...
public class OrderController {
    ...
    public ResponseEntity<Order> addOrder(@PathVariable("userId") Long userId) {
        return new ResponseEntity<>(orderServiceImple.createOrderFromCart(userId), HttpStatus.OK);
    }
    ...
    @GetMapping("find/total/user/{id}")
    public ResponseEntity<Long> getTotal(@PathVariable("id") Long id){
        return new ResponseEntity<>(orderServiceImple.getTotalBill(id),HttpStatus.OK);
    }
    ...
    @GetMapping("find/total/coupon/{couponcode}/user/{id}")
    public ResponseEntity<Long> getTotalBillWithCoupon(@PathVariable("id") Long id,@PathVariable("couponcode")String couponcode){
        return new ResponseEntity<>(orderServiceImple.getTotalBillWithCoupon(id,couponcode),HttpStatus.OK);
    }
